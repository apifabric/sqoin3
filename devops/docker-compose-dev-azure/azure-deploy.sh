...
resourcename="sqoin3"  # lower case, only
resourcegroup="sqoin3_rg"
...
# git clone https://github.com/apilogicserver/sqoin3.git
# cd sqoin3
...
az group create --name sqoin3_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group sqoin3_rg --sku S1 --is-linux
az container create --resource-group sqoin3_rg --name sqoin3 --image apilogicserver/sqoin3:latest --dns-name-label sqoin3 --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//sqoin3.westus.azurecontainer.io:5656'
