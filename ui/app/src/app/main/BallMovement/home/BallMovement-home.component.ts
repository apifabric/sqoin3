...
@Component({
  selector: 'BallMovement-home',
  templateUrl: './BallMovement-home.component.html',
  styleUrls: ['./BallMovement-home.component.scss']
})
export class BallMovementHomeComponent implements AfterViewInit {
