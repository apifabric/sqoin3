...
@Component({
  selector: 'Paddle-home',
  templateUrl: './Paddle-home.component.html',
  styleUrls: ['./Paddle-home.component.scss']
})
export class PaddleHomeComponent implements AfterViewInit {
