...
@Component({
  selector: 'GameSetting-home',
  templateUrl: './GameSetting-home.component.html',
  styleUrls: ['./GameSetting-home.component.scss']
})
export class GameSettingHomeComponent implements AfterViewInit {
