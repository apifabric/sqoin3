...
@Component({
  selector: 'Collision-home',
  templateUrl: './Collision-home.component.html',
  styleUrls: ['./Collision-home.component.scss']
})
export class CollisionHomeComponent implements AfterViewInit {
