...
@Component({
  selector: 'PowerUp-home',
  templateUrl: './PowerUp-home.component.html',
  styleUrls: ['./PowerUp-home.component.scss']
})
export class PowerUpHomeComponent implements AfterViewInit {
